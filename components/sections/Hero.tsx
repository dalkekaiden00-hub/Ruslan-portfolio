      ...
      <Container>
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-10">
            ...
            <h1 className="display text-[44px] sm:text-[60px] md:text-[76px] leading-[1.02] tracking-[-0.025em] text-ink max-w-[18ch]">
            ...
            <p className="mt-10 max-w-[58ch] text-lead text-muted leading-[1.6]">
              {profile.intro}
            </p>
